    ...
    public partial class ResultPage : ContentPage
    {
        ...
        public ResultPage()
        {
            ...
            using (StreamReader reader = new StreamReader(filePath))
            {
                ...
                {
                    MatchCollection matches = Regex.Matches(line, @"(\!\=|\-\=|\*\=|\/\=|\%\=|\>\>\>\=|\<\<\=|\>\>\=|\&\=|\|\=|\^\=|\&\&|\|\||\+\+|\-\-|\&|\||\^|\~|\>\>\>|\>\>|\<\<|\!|\*|\+|\-|\=\>|\=\<|\>|\<|\=\=|\=|\[|\(|\;|\{|for\ *\n*\(|switch\ *\n*\(|if\ *\n*\(|else\ *\n*\{|while\ *\n*\(|case\ *\:|break|continue|default|do|goto|\.|try\ *\n*\{|catch\ *\n*\(|return)");//@"(\!\=|\-\=|\*\=|\/\=|\%\=|\>\>\>\=|\<\<\=|\>\>\=|\&\=|\|\=|\^\=|\&\&|\|\||\+\+|\-\-|\&|\||\^|\~|\>\>\>|\>\>|\<\<|\!|\*|\+|\-|\=\>|\=\<|\>|\<|\=\=|\=|\[|\(|\;|\{|for\ *\n*\(|switch\ *\n*\(|if\ *\n*\(|else\ *\n*\{|while\ *\n*\(|case\ *\:|break|continue|default|do|goto|\.|try\ *\n*\{|catch\ *\n*\(|return)\ *(?=(?:[^""\\]*(\\.|""([^""\\]*\\.)*[^""\\]*""))*[^""]*$)\ *");//@"\b(-=|\*=|\/=|%=|<<=|>>=|>>>=|&=|\|=|\^=|&&|\|\||\+\+|--|&|\||\^|~|>>|<<|>>>|!|\*|\+|\-|>|<|=>|=<|==|!=|\|\||\[\]|\(\)|;|:|{}|for|switch|if|else|while|case|break|continue|default|do|goto|\.|try|catch|return\w+)\b(?=(?:[^""\\]*(\\.|""([^""\\]*\\.)*[^""\\]*""))*[^""]*$)\b");
                    ...
                    MatchCollection matches5 = Regex.Matches(line, @"(\(){1}\ *(\""|\'){1}([A-Za-z0-9_\.\:\ ]+)(\""|\'){1}");//@"(\(){1}\ *(\""|\')?([A-Za-z0-9_\.\:\ ]+)(""|\')?"); //(\(){1}\ *(\"|\'){1}([A-Za-z0-9_\.\:\ ]+)(\"|\'){1}
                    MatchCollection matches6 = Regex.Matches(line, @"(\(){1}\ *([A-Za-z0-9_\.\,\ \[\]\+\-\*\/\%\=\!\>\<\&\|\^\~]+)(\)){1}"); //(\,|\;){1}\ *([A-Za-z0-9_\.]+)

                    foreach (Match match in matches)
                    {
                        string operatorValue = match.Groups[1].Value;
                    ...
                    foreach (Match match in matches3)
                    {
                        ...
                        if (operandValue != "" && IsKeyword(operandValue) == false) 
                        {
                    ...
                    foreach (Match match in matches5)
                    {
                        ...
                        if (operandValue != "" && IsType(operandValue) == false)
                        {
                            if (!operandCounts.ContainsKey(operandValue))
                            {
                                operandCounts[operandValue] = 0;
...
//10, 5, 3, 7, 2, a, b, c, d, e, isGreater, isEqual, isNotEqual, i, sum, product, difference, quotient, 
//remainder, logicalAnd, logicalOr, logicalNot, +11

//\ *(|\;|\{|for|switch|if|else|while|case|break|continue|default|do|goto|\.|try|catch|return)\ *(?=(?:[^""\\]*(\\.|""([^""\\]*\\.)*[^""\\]*""))*[^""]*$)\ *
